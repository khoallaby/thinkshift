            ...
            <div class="col-sm-7">
                <div class="header-content">
                    <div class="header-content-inner">
                        <h1>Reach New Audiences. Further Your Organizations Mission.</h1>
                        <a href="mailto:info@wethinkshift.org?subject=Partnership" class="btn btn-outline btn-xl page-scroll">Partner With Us</a>
                    </div>
                </div>
            </div>
        </div>
